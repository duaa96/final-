<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/PageStudents/student.Master" CodeBehind="ShowStates.aspx.cs" Inherits="WebApplication1.ShowStates" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    margin: 0 auto; margin-right:7%; margin-left:3%; ">
      ...
      <label for="exampleInpuStudentsNum"  style="float:right;  font-family:'Amiri'; font-size:xx-large;">تحية طيبة وبعد ،الموضوع :</label>
         <asp:RequiredFieldValidator runat="server" ForeColor="Red" ID="RequiredFieldValidator1" ControlToValidate="txtStatus" ErrorMessage="*"></asp:RequiredFieldValidator>
